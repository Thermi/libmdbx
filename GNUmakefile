...
MDBX_GIT_TIMESTAMP := $(shell git show --no-patch --format=%cI HEAD || echo 'Please install latest git version')
...
MDBX_GIT_TREE := $(shell git show --no-patch --format=%T HEAD || echo 'Please install latest git version')
MDBX_GIT_COMMIT := $(shell git show --no-patch --format=%H HEAD || echo 'Please install latest git version')
